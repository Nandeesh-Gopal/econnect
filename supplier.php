    ...
    <main class="container mt-5">
            ...
            if($check !== false) {
                if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
                    $sql = "INSERT INTO basha (name, price, description, image, phone, email)
                            VALUES ('$name', '$price', '$description', '$target_file', '$phone', '$email')";
        ...
        <form id="supplier-form" class="needs-validation" method="post" enctype="multipart/form-data" novalidate>
            ...
            <div class="form-group">
                ...
                <input type="tel" class="form-control" id="phone" name="phone" pattern="\d{10}" placeholder="Format: 1234567890" required>
                <div class="invalid-feedback">Please enter a valid phone number (Format: 1234567890).</div>
            </div>
            <div class="form-group">
